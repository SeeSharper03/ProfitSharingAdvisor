...
describe('c3 chart axis', function () {
    ...
    describe('axis.y.type', function () {
        describe('type=log', function () {
            ...
            it('should have bars from y bigger than y2', function () {
                expect(d3.select('.c3-bars-log .c3-bar-5').node().getBBox().height).toBeGreaterThan(d3.select('.c3-bars-linear .c3-bar-5').node().getBBox()
                    .height);
            });
            it('should not have truncated data label', function () {
                var text = d3.select('.c3-texts-log .c3-text-0').node();
        ...
        describe('indexed x axis and y/y2 axis', function () {
            describe('not rotated', function () {
                ...
                it('should construct indexed x axis properly', function () {
                    var ticks = chart.internal.main
                        .select('.c3-axis-x')
                        .selectAll('g.tick'), expectedX = '0', expectedDy = '.71em';
                    expect(ticks.size()).toBe(6);
                ...
                describe('should set axis.x.tick.format', function () {
                    ...
                    it('should split x axis tick text to multiple lines', function () {
                        var ticks = chart.internal.main
                            .select('.c3-axis-x')
                            .selectAll('g.tick'), expectedTexts = ['very long tick text', 'on x axis'], expectedX = '0';
                        expect(ticks.size()).toBe(6);
                        ticks.each(function () {
                            var tspans = d3.select(this).selectAll('tspan');
                    ...
                    it('should construct y axis properly', function () {
                        var ticks = chart.internal.main
                            .select('.c3-axis-y')
                            .selectAll('g.tick'), expectedX = '-9', expectedDy = '3';
            ...
            describe('rotated', function () {
                ...
                it('should split x axis tick text to multiple lines', function () {
                    var ticks = chart.internal.main
                        .select('.c3-axis-x')
                        .selectAll('g.tick'), expectedTexts = ['very long tick text on', 'x axis'], expectedX = '-9';
                    expect(ticks.size()).toBe(6);
                    ticks.each(function () {
                        var tspans = d3.select(this).selectAll('tspan');
                        expect(tspans.size()).toBe(2);
                ...
                it('should not split y axis tick text to multiple lines', function () {
                    var ticks = chart.internal.main
                        .select('.c3-axis-y')
                        .selectAll('g.tick'), expectedTexts = [
                        '0',
                        '500000000000000',
                        '1000000000000000',
                        '1500000000000000',
            ...
            describe('not rotated', function () {
                ...
                it('should locate ticks properly', function () {
                    var ticks = chart.internal.main
                        ...
                        .selectAll('g.tick');
                    ticks.each(function (d, i) {
                        var tspans = d3.select(this).selectAll('tspan'), expectedX = '0', expectedDy = '.71em';
                        if (i > 0) {
            ...
            describe('rotated', function () {
                ...
                it('should locate ticks on rotated axis properly', function () {
                    var ticks = chart.internal.main
                        ...
                        .selectAll('g.tick');
                    ticks.each(function (d, i) {
                        var tspans = d3.select(this).selectAll('tspan'), expectedX = '-9', expectedDy = '3';
                        if (i > 0) {
                            // i === 0 should be checked in next test
                            expect(tspans.size()).toBe(1);
                            tspans.each(function () {
            ...
            describe('option used', function () {
                describe('as null', function () {
                    ...
                    it('should split x tick', function () {
                        var tick = chart.internal.main
                            .select('.c3-axis-x')
                            .select('g.tick'), tspans = tick.selectAll('tspan');
                        expect(tspans.size()).toBe(1);
                    });
                });
                describe('as value', function () {
                    ...
                    it('should split x tick to 2 lines properly', function () {
                        var tick = chart.internal.main
                            .select('.c3-axis-x')
                            .select('g.tick'), tspans = tick.selectAll('tspan'), expectedTickTexts = [
        ...
        describe('not rotated', function () {
            ...
            it('should rotate tick texts', function () {
                chart.internal.main.selectAll('.c3-axis-x g.tick').each(function () {
                    var tick = d3.select(this), text = tick.select('text'), tspan = text.select('tspan');
            ...
            it('should have automatically calculated x axis height', function () {
                var box = chart.internal.main
                    .select('.c3-axis-x')
                    .node()
                    .getBoundingClientRect(), height = chart.internal.getHorizontalAxisHeight('x');
    ...
    describe('axis.y.inner', function () {
        ...
        it('should not have inner y axis', function () {
            var paddingLeft = chart.internal.getCurrentPaddingLeft(), tickTexts = chart.internal.main.selectAll('.c3-axis-y g.tick text');
    ...
    describe('axis.y2.inner', function () {
        ...
        it('should not have inner y axis', function () {
            var paddingRight = chart.internal.getCurrentPaddingRight(), tickTexts = chart.internal.main.selectAll('.c3-axis-2y g.tick text');
    ...
    describe('axis.x.label', function () {
        ...
        it('renders label text properly', function () {
        ...
        describe('outer label position', function () {
            ...
            it('renders position properly', function () {
