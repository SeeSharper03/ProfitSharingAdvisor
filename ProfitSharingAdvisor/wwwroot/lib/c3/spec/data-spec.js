...
describe('load without data', function () {
    ...
    it('throws when data is an empty object', function () {
        expect(function () { return initChart(chart, args, function () { }); }).toThrowError(Error, /url or json or rows or columns is required/);
    });
});
describe('c3 chart data', function () {
    ...
    describe('load json', function () {
        ...
        it('should draw correctly', function () {
            var expectedCx = [6, 299, 593], expectedCy = [371, 391, 332];
        ...
        describe('more data', function () {
            ...
            it('should draw correctly', function () {
                var expectedCx = { 443: [98, 294, 490], 995: [98, 294, 490] }, expectedCy = { 443: [194, 351, 36], 995: [391, 430, 351] };
        ...
        describe('with nested JSON args', function () {
            ...
            it('should draw nested JSON correctly', function () {
                var expectedCx = [98, 294, 490], expectedCy = {
                    443: [181, 326, 36],
                    995: [362, 398, 326],
                    112: [354, 347, 340],
                    223: [391, 383, 376],
    ...
    describe('load rows', function () {
        ...
        it('should draw correctly', function () {
            var expectedCx = [6, 124, 241, 358, 475, 593], expectedCy = [327, 391, 378, 289, 340, 327];
            d3.selectAll('.c3-circles-data1 .c3-circle').each(function (d, i) {
                var circle = d3.select(this);
                expect(+circle.attr('cx')).toBeCloseTo(expectedCx[i], 0);
                expect(+circle.attr('cy')).toBeCloseTo(expectedCy[i], 0);
        ...
        describe('with positive values and null', function () {
            describe('on not rotated axis', function () {
                ...
                it('should locate labels above each data point', function () {
                    var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [67, 49, 67, 423], expectedXs = [74, 221, 368, 515];
                ...
                describe('data type line', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [375, 40, 375, 422], expectedXs = [6, 198, 391, 583];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
            ...
            describe('on rotated axis', function () {
                describe('data type bar', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [57, 163, 269, 375], expectedXs = [490, 516, 490, 4];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
                ...
                describe('data type line', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [9, 147, 286, 424], expectedXs = [76, 526, 76, 4];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
        ...
        describe('with negative values and null', function () {
            describe('on not rotated axis', function () {
                describe('type bar', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [368, 12, 368, 12], expectedXs = [74, 221, 368, 515];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
                ...
                describe('data type line', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [395, 60, 395, 12], expectedXs = [6, 198, 391, 583];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
            ...
            describe('on rotated axis', function () {
                describe('data type bar', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [57, 163, 269, 375], expectedXs = [103, 594, 103, 526];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
                ...
                describe('data type line', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [9, 147, 286, 424], expectedXs = [67, 537, 67, 526];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
        ...
        describe('with positive and negative values and null', function () {
            describe('on non rotated axis', function () {
                describe('data type bar', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [392, 43, 52, 215], expectedXs = [74, 221, 368, 515];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
                ...
                describe('data type line', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [392, 40, 49, 212], expectedXs = [6, 198, 391, 583];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
            ...
            describe('on rotated axis', function () {
                describe('data type bar', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [57, 163, 269, 375], expectedXs = [69, 525, 513, 295];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
                ...
                describe('data type line', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [9, 147, 286, 424], expectedXs = [67, 527, 515, 297];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
        ...
        describe('with positive grouped values', function () {
            describe('on non rotated axis', function () {
                describe('data type bar', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [385, 317, 370, 164], expectedXs = [74, 221, 368, 515];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
                ...
                describe('data type line', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [344, 284, 331, 144], expectedXs = [6, 198, 391, 583];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
            ...
            describe('on rotated axis', function () {
                describe('data type bar', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [57, 163, 269, 375], expectedXs = [57, 150, 77, 363];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
                ...
                describe('data type line', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [9, 147, 286, 424], expectedXs = [107, 192, 125, 386];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
        ...
        describe('with negative grouped values', function () {
            describe('on non rotated axis', function () {
                describe('data type bar', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [51, 118, 65, 272], expectedXs = [74, 221, 368, 515];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
                ...
                describe('data type line', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [88, 149, 101, 288], expectedXs = [6, 198, 391, 583];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
            ...
            describe('on rotated axis', function () {
                describe('data type bar', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [57, 163, 269, 375], expectedXs = [533, 440, 513, 230];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
                ...
                describe('data type line', function () {
                    ...
                    it('should locate labels above each data point', function () {
                        var texts = chart.internal.main.selectAll('.c3-texts-data1 text'), expectedYs = [9, 147, 286, 424], expectedXs = [480, 397, 462, 205];
                        texts.each(function (d, i) {
                            var text = d3.select(this);
                            expect(+text.attr('y')).toBeCloseTo(expectedYs[i], -2);
                            expect(+text.attr('x')).toBeCloseTo(expectedXs[i], -2);
    ...
    describe('data.stack', function () {
        ...
        var getChartHeight = function () {
            return +chart.internal.main.select(".c3-event-rect").attr('height') - 1;
        };
        it('check for the normalized y axis tick in percentage', function () {
            var tick = chart.internal.main.selectAll(".c3-axis-y .tick tspan");
            // check for the y axis to be in percentage
            tick.each(function (v, i) {
                expect(this.textContent).toEqual(i * 10 + "%");
            });
        });
        it("check for the normalized bar's height", function () {
            var chartHeight = getChartHeight();
            var bars = chart.internal.main.selectAll('.c3-bar').nodes();
            bars.splice(0, 3).forEach(function (v, i) {
                expect(v.getBBox().height + bars[i].getBBox().height).toEqual(chartHeight);
            });
        });
        it('check when hiding data', function (done) {
            var chartHeight = getChartHeight();
            // when
            chart.hide('data1');
            setTimeout(function () {
        ...
        describe('timeseries chart', function () {
            beforeAll(function () {
                args = {
                    data: {
                        x: 'date',
        ...
        describe('area chart', function () {
            ...
            it("check for the normalized area's height", function () {
                var chartHeight = getChartHeight();
                var areaHeight = 0;
