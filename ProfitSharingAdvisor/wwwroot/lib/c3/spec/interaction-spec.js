...
describe('c3 chart interaction', function () {
    ...
    var moveMouseOut = function () {
        return setMouseEvent(chart, 'mouseout', 0, 0, d3.select('.c3-event-rect').node());
    };
    var moveMouse = function (x, y) {
        if (x === void 0) { x = 0; }
        if (y === void 0) { y = 0; }
        return setMouseEvent(chart, 'mousemove', x, y, d3.select('.c3-event-rect').node());
    };
    var clickMouse = function (x, y) {
        if (x === void 0) { x = 0; }
        if (y === void 0) { y = 0; }
        return setMouseEvent(chart, 'click', x, y, d3.select('.c3-event-rect').node());
    };
    ...
    describe('bar chart', function () {
        describe('tooltip_grouped=true', function () {
            ...
            it('generate a single rect', function () {
                var eventRectList = d3.selectAll('.c3-event-rect');
            ...
            it('shows tooltip with visible data of currently hovered category', function () {
                moveMouse(20, 20);
                expect(document.querySelector('.c3-tooltip-container').style.display).toEqual('block');
                var tooltipData = __spreadArray([], document.querySelectorAll('.c3-tooltip tr'));
            ...
            it('shows cursor:pointer only if hovering bar', function () {
                var eventRect = d3.select('.c3-event-rect');
                moveMouse(1, 1);
            ...
            it('expands all bars of currently hovered category', function () {
                moveMouse(20, 20);
                var barList = d3.selectAll('.c3-bar');
                expect(barList.size()).toBeGreaterThan(0);
                barList.each(function () {
                    if (this.classList.contains('c3-bar-0') &&
                        !this.parentElement.classList.contains('c3-bars-data1')) {
                ...
                moveMouse(20, 170);
                barList.each(function () {
                    if (this.classList.contains('c3-bar-2') &&
                        !this.parentElement.classList.contains('c3-bars-data1')) {
                        expect(this.classList.contains('_expanded_')).toBeTruthy();
                    }
                    else {
        ...
        describe('tooltip_grouped=false', function () {
            ...
            it('shows tooltip with only hovered data', function () {
                moveMouse(1, 1);
            ...
            it('expands only hovered bar', function () {
                moveMouse(20, 20);
                var barList = d3.selectAll('.c3-bar');
                expect(barList.size()).toBeGreaterThan(0);
                // nothing expanded
                ...
                barList.each(function () {
                    if (this.classList.contains('c3-bar-0') &&
                        this.parentElement.classList.contains('c3-bars-data2')) {
                        expect(this.classList.contains('_expanded_')).toBeTruthy();
                    }
                    else {
                        expect(this.classList.contains('_expanded_')).toBeFalsy();
    ...
    describe('line chart', function () {
        describe('tooltip_grouped=false', function () {
            ...
            it('expands only hovered point', function () {
                moveMouse(1, 1);
                var circleList = d3.selectAll('.c3-circle');
                ...
                moveMouse(45, 233);
                circleList.each(function () {
                    expect(this.classList.contains('_expanded_')).toEqual(this.classList.contains('c3-circle-0') &&
                        this.parentElement.classList.contains('c3-circles-data2'));
                });
            });
            it('shows cursor:pointer only if hovering point', function () {
                var eventRect = d3.select('.c3-event-rect');
                moveMouse(1, 1);
                expect(eventRect.style('cursor')).toEqual('auto');
                moveMouse(49, 219);
            ...
            it('clicks only on hovered point', function () {
                clickMouse(144, 201);
            ...
            describe('with selection enabled', function () {
                ...
                it('can toggle selection', function () {
            ...
            describe('with tooltip_horizontal=true', function () {
                beforeAll(function () {
                    args.tooltip.horizontal = true;
                });
                it('can clicks on points', function () {
                ...
                it('shows tooltip with only closest data', function () {
                    moveMouse(1, 1);
                    expect(document.querySelector('.c3-tooltip-container').style
                        .display).toEqual('none');
                    moveMouse(146, 46);
                    expect(document.querySelector('.c3-tooltip-container').style
                        .display).toEqual('block');
                    var tooltipData = __spreadArray([], document.querySelectorAll('.c3-tooltip tr'));
                    ...
                    expect(document.querySelector('.c3-tooltip-container').style
                        .display).toEqual('block');
                    tooltipData = __spreadArray([], document.querySelectorAll('.c3-tooltip tr'));
                    expect(tooltipData.length).toBe(2); // header + data3
                    expect(tooltipData[1].querySelector('.name').textContent).toBe('data3');
        ...
        describe('tooltip_grouped=true', function () {
            ...
            describe('with tooltip_horizontal=true', function () {
                ...
                it('shows tooltip with all data', function () {
                    moveMouse(1, 1);
                    expect(document.querySelector('.c3-tooltip-container').style
                        .display).toEqual('block');
                    var tooltipData = __spreadArray([], document.querySelectorAll('.c3-tooltip tr'));
    ...
    describe('area chart (timeseries)', function () {
        describe('tooltip_grouped=true', function () {
            ...
            it('shows cursor:pointer only if hovering area', function () {
                var eventRect = d3.select('.c3-event-rect');
                moveMouse(1, 1);
                expect(eventRect.style('cursor')).toEqual('auto');
                moveMouse(360, 48);
    ...
    describe('disabled', function () {
        ...
        it('does not show tooltip when hovering data', function () {
            moveMouse(40, 260);
            expect(document.querySelector('.c3-tooltip-container').style.display).toEqual('none');
        });
        it('does not show cursor:pointer when hovering data', function () {
            moveMouse(40, 260);
