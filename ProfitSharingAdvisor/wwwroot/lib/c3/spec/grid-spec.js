...
describe('c3 chart grid', function () {
    ...
    describe('y grid show', function () {
        ...
        describe('with y grids depending on y axis ticks', function () {
            ...
            it('should show grids depending on y axis ticks', function () {
                var ygrids = chart.internal.main.select('.c3-ygrids'), expectedYs = [];
    ...
    describe('y grid lines', function () {
        describe('position', function () {
            ...
            it('should locate grid lines properly', function () {
                var lines = chart.internal.main.selectAll('.c3-ygrid-lines .c3-ygrid-line'), expectedY1s = [373, 268, 196];
            ...
            it('should locate grid texts properly', function () {
                var lines = chart.internal.main.selectAll('.c3-ygrid-lines .c3-ygrid-line'), expectedPositions = ['start', 'middle', 'end'], expectedDxs = [4, 0, -4];
                lines.each(function (d, i) {
                    var text = d3.select(this).select('text'), textAnchor = text.attr('text-anchor'), dx = text.attr('dx');
            ...
            describe('three gridlines', function () {
                ...
                it('should show 3 grid lines', function () {
                    expect(chart.internal.main
                        .selectAll('.c3-ygrid-lines .c3-ygrid-line')
                        .size()).toBe(3);
                });
                it('should locate grid lines properly', function () {
                    var lines = chart.internal.main.selectAll('.c3-ygrid-lines .c3-ygrid-line'), expectedX1s = [75, 220, 321];
                    lines.each(function (d, i) {
                        var x1 = d3
                            .select(this)
                            .select('line')
    ...
    describe('x grid lines', function () {
        describe('position', function () {
            ...
            it('should locate grid lines properly', function () {
                var lines = chart.internal.main.selectAll('.c3-xgrid-lines .c3-xgrid-line'), expectedX1s = [202, 397, 593];
                lines.each(function (d, i) {
                    var x1 = d3
                        .select(this)
                        .select('line')
            ...
            it('should locate grid texts properly', function () {
                var lines = chart.internal.main.selectAll('.c3-xgrid-lines .c3-xgrid-line'), expectedPositions = ['start', 'middle', 'end'], expectedDxs = [4, 0, -4];
                lines.each(function (d, i) {
                    var text = d3.select(this).select('text'), textAnchor = text.attr('text-anchor'), dx = text.attr('dx');
                    expect(textAnchor).toBe(expectedPositions[i]);
                    expect(+dx).toBe(expectedDxs[i]);
        ...
        describe('with padding.top', function () {
            describe('should have correct height', function () {
                ...
                it('should show x grid lines', function () {
                    var lines = chart.internal.main.select('.c3-xgrid-lines .c3-xgrid-line'), expectedX1 = 593, expectedText = ['Label 3'];
                    lines.each(function (id, i) {
                        var line = d3.select(this), l = line.select('line'), t = line.select('text');
        ...
        describe('on category axis', function () {
            ...
            it('should show x grid lines', function () {
                var lines = chart.internal.main.selectAll('.c3-xgrid-lines .c3-xgrid-line'), expectedX1 = [515, 74], expectedText = ['Label 3', 'Label a'];
                lines.each(function (id, i) {
                    var line = d3.select(this), l = line.select('line'), t = line.select('text');
