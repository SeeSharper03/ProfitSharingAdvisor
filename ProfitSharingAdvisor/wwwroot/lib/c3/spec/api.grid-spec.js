...
describe('c3 api grid', function () {
    ...
    describe('ygrid.add and ygrid.remove', function () {
        ...
        it('updates y grids', function (done) {
            var main = chart.internal.main, expectedGrids = [
                {
                    value: 100,
                    text: 'Pressure Low'
                },
            ...
            setTimeout(function () {
                ...
                grids.each(function (d, i) {
                    var y = +d3
                        ...
                        .select(this)
                        .select('text')
                        .text(), expectedY = Math.round(chart.internal.y(expectedGrids[i].value)), expectedText = expectedGrids[i].text;
                ...
                setTimeout(function () {
                    ...
                    grids.each(function (d, i) {
                        var x = +d3
                            ...
                            .select(this)
                            .select('text')
                            .text(), expectedX = Math.round(chart.internal.x(expectedGrids[i].value)), expectedText = expectedGrids[i].text;
